...
multiple_student_subjects = [
    (924001330058, 'Aum Dave', 'PWP', 95),
    (924001330058, 'Aum Dave', 'ICE', 92),
    (924001330058, 'Aum Dave', 'DMGT', 88),
    (924001330058, 'Aum Dave', 'DSC', 91),
    (924001330058, 'Aum Dave', 'SS', 87),
    (924001330058, 'Aum Dave', 'SPDT', 93),
    (924001330058, 'Aum Dave', 'APTI', 89),
    (924001330058, 'Aum Dave', 'COA', 94)
]
cursor.executemany('''
...
cursor.execute('''
    ...
    SET Mark = 98
    WHERE Enrollment = 924001330058 AND Subject = 'ICE'
''')
conn.commit()
cursor.execute('''
...
cursor.execute('''
    ...
    WHERE Enrollment = 924001330058 AND Subject = 'DMGT'
''')
conn.commit()
cursor.execute('''
...
print(f"\nThe average mark of the student is: {avg_mark:.2f}")
conn.close()
